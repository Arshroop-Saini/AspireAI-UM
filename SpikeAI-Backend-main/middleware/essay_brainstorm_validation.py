...
def validate_essay_brainstorm_profile():
    def decorator(f):
        @wraps(f)
        def decorated_function(*args, **kwargs):
            try:
                ...
                # Get student profile using the correct method
                ...
                # Required fields for essay brainstorming
                required_fields = {
                    'name': 'Name',
                    'major': 'Major',
                ...
                logger.error(f"Error in essay brainstorm validation: {str(e)}")
                return jsonify({
                    "success": False,
